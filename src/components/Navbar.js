    ...
    <section style={{ backgroundColor: `${color}` }} className='fixed left-0 top-0 w-full z-10 ease-in duration-300'>
      ...
      <div className='max-w-[1240px] m-auto flex justify-between items-center p-4 text-white'>
        ...
        <div className={openNav ? 'sm:hidden absolute top-0 left-0 right-0 bottom-0 flex justify-center items-center w-full h-screen bg-black text-center ease-in duration-300'
          ...
          <ul>
            <li className='p-4 text-4xl hover:text-gray-500' onClick={openNavHandler}><Link href='/'>Home</Link></li>
            <li className='p-4 text-4xl hover:text-gray-500' onClick={openNavHandler}><Link href='/#gallery'>Gallery</Link></li>
            <li className='p-4 text-4xl hover:text-gray-500' onClick={openNavHandler}><Link href='/work'>Work</Link></li>
            <li className='p-4 text-4xl hover:text-gray-500' onClick={openNavHandler}><Link href='/contact'>Contact</Link></li>
          </ul>
        </div>
